    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            switch ( b.getInt("line",3)){
                case 0:rv = new RemoteViews(context.getPackageName(), R.layout.widgea);
                break;
                case 1:rv = new RemoteViews(context.getPackageName(), R.layout.widgeb);
                break;
                case 2:rv = new RemoteViews(context.getPackageName(), R.layout.widgec);
                break;
                default: rv = new RemoteViews(context.getPackageName(), R.layout.widget);
                break;
            }
            ...
            switch (b.getInt("gravity",17)){
                 case 51:s=R.id.topleft;
                 break;
                 case 49:s=R.id.topcenter;
                 break;
                 case 53:s=R.id.topright;
                 break;
                 case 19:s=R.id.centerleft;
                 break;
                 case 21:s=R.id.centerright;
                 break;
                 case 83:s=R.id.bottomleft;
                 break;
                 case 81:s=R.id.bottomcenter;
                 break;
                 case 85:s=R.id.bottomright;
                 break;
                 default:s=R.id.centercenter;
                 break;
            }
            ...
            rv.setTextViewText(s, Html.fromHtml(b.getString("content","\n").replace("\n", "<br>")));
